...
PIVOT_X = SURF_SIZE // 2
PIVOT_Y = SURF_SIZE // 2
HEAD_CX = PIVOT_X + HANDLE_LEN + NECK_LEN + HEAD_W // 2 - 4
...
async def main():
    global player1_x, player1_y, player2_y
    global ball_x, ball_y, ball_speed_x, ball_speed_y
    global score1, score2
    global p1_phase, p1_angle, p1_pt, p1_dir
    global p2_phase, p2_angle, p2_pt, p2_dir
